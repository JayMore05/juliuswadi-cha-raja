...
export default function UpdatesCTA() {
  return (
    <section className="relative overflow-hidden bg-[#FFF8F2] py-16 sm:py-20 lg:py-28">
      ...
      <div className="absolute -top-24 left-0 h-80 w-80 rounded-full bg-yellow-300/20 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-6">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-orange-50 sm:text-lg lg:text-xl">
            Stay connected with Juliuswadi Cha Raja for festival
            announcements, important events and community activities.
          </p>
