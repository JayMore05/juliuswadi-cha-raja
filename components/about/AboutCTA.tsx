...
export default function AboutCTA() {
  return (
    <section className="relative overflow-hidden bg-[#FFF8F2] py-16 sm:py-20 lg:py-28">
      ...
      <div className="absolute -top-20 left-0 h-80 w-80 rounded-full bg-yellow-300/20 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-6">
        ...
        <motion.div
          ...
          "
        >
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-white/20 shadow-xl">
            <Heart size={38} />
          </div>
          ...
          <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-orange-50 sm:text-lg lg:text-xl">
            Join us in celebrating faith, devotion and togetherness.
            Whether you visit, volunteer or support the Mandal,
