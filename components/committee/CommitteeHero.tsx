      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-6">
        ...
        >
          ...
          <p
            ...
            "
          >
            Behind every successful Ganesh Festival is a dedicated team
            of volunteers and committee members working with devotion,
            unity and commitment to serve the community.
          </p>
